...
public class DrivingRouteFormatterTest extends TestCase {
    ...
    public void testShortDirections() throws IOException {
        ...
        assertEquals("Turn right onto Penny Lane and go 5.1 miles.\n", 
                     mDirections.computeDirections(mShortRoute, 0));
        
        assertEquals("Turn slight left onto Penny Lane and go 5.1 miles.\n", 
                     mDirections.computeDirections(mShortRoute, 100));
        assertEquals("Turn slight right onto Penny Lane and go 5.1 miles.\n", 
                     mDirections.computeDirections(mShortRoute, 80));

        assertEquals("Continue onto Penny Lane and go 5.1 miles.\n", 
                     mDirections.computeDirections(mShortRoute, 99));
        assertEquals("Continue onto Penny Lane and go 5.1 miles.\n", 
                     mDirections.computeDirections(mShortRoute, 81));

        assertEquals("Turn sharp right onto Penny Lane and go 5.1 miles.\n", 
                     mDirections.computeDirections(mShortRoute, 330));
        assertEquals("Turn sharp left onto Penny Lane and go 5.1 miles.\n", 
                     mDirections.computeDirections(mShortRoute, 231));

        assertEquals("U-turn onto Penny Lane and go 5.1 miles.\n", 
    ...
    public void testTurning() {
        ...
        assertEquals("Turn left onto Penny Lane and go 6.9 miles.\n",
        ...
        mShortRoute = new Route(new GeoSegment(mName,
                                               new GeoPoint(0,0),
                                               new GeoPoint(-oneUnit,0)));
        assertEquals("Turn right onto Penny Lane and go 6.9 miles.\n",
                     mDirections.computeDirections(mShortRoute, 90));
        ...
        assertEquals("Turn slight left onto Penny Lane and go 2.0 miles.\n",
                     mDirections.computeDirections(mShortRoute, 180));
        ...
        mShortRoute = new Route(new GeoSegment(mName,
                                               new GeoPoint(0,0),
                                               new GeoPoint(-27988,-10134)));
        assertEquals("Turn slight right onto Penny Lane and go 2.0 miles.\n",
                     mDirections.computeDirections(mShortRoute, 180));
        ...
        mShortRoute = new Route(new GeoSegment(mName,
                                               new GeoPoint(0,0),
                                               new GeoPoint(27988,10134)));
        assertEquals("Turn sharp left onto Penny Lane and go 2.0 miles.\n",
                     mDirections.computeDirections(mShortRoute, 180));
        ...
        mShortRoute = new Route(new GeoSegment(mName,
                                               new GeoPoint(0,0),
                                               new GeoPoint(27988,-10134)));
        assertEquals("Turn sharp right onto Penny Lane and go 2.0 miles.\n",
                     mDirections.computeDirections(mShortRoute, 180));
        ...
        assertEquals("U-turn onto Penny Lane and go 50.0 miles.\n",
                     mDirections.computeDirections(mShortRoute, 0));
    ...
    public void testDistance() {
        ...
        mShortRoute = new Route(new GeoSegment(mName,
                                               new GeoPoint(0,0),
                                               new GeoPoint(0,1566)));
        assertEquals("Continue onto Penny Lane and go 0.1 miles.\n",
                     mDirections.computeDirections(mShortRoute, 90));
        ...
        mShortRoute = new Route(new GeoSegment(mName,
                                               new GeoPoint(0,0),
                                               new GeoPoint(0,392)));
        assertEquals("Continue onto Penny Lane and go 0.0 miles.\n",
                     mDirections.computeDirections(mShortRoute, 90));
    }
    ...
    public void testRepeatedSegment() {
        ...
        assertEquals("Turn left onto Penny Lane and go 10.2 miles.\n",
